...
Expected result: same result on both nodes

## get_blog
`python3 get_blog.py https://api.steem.house https://api.steemit.com ./ 1 blocktardes 0 1`

**Expected result: Differences found at post_id and json_metadata**
...
**Expected result: Differences found at follower_count**
